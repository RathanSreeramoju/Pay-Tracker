...
public class YearlyReportsActivity extends BaseActivity {
    ListView lv;
    Spinner spin_jobs;
    ...
    private void serverData(){
        ...
        progressDialog = new ProgressDialog(YearlyReportsActivity.this);
        ...
        call.enqueue(new Callback<List<PaymentPojo>>() {
            ...
            public void onResponse(Call<List<PaymentPojo>> call, Response<List<PaymentPojo>> response) {
                ...
                if(response.body()==null){
                    Toast.makeText(YearlyReportsActivity.this,"No data found",Toast.LENGTH_SHORT).show();
                }else {
                    payments = response.body();
                    //Toast.makeText(ReportsActivity.this,""+payments.size(),Toast.LENGTH_SHORT).show();

                    reportsAdapters=new ReportsAdapter(payments, YearlyReportsActivity.this);
            ...
            public void onFailure(Call<List<PaymentPojo>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(YearlyReportsActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getJobs() {
        ...
        call.enqueue(new Callback<List<JobTitlePojo>>() {
            ...
            public void onResponse(Call<List<JobTitlePojo>> call, Response<List<JobTitlePojo>> response) {
                ...
                ArrayAdapter aa = new ArrayAdapter(YearlyReportsActivity.this, android.R.layout.simple_spinner_item, myjobs);
