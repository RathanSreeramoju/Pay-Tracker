...
import java.util.List;
    ...
    public class YearSelectionAdapter extends BaseAdapter {
        List<YearSelectionPojo> ar;
        Context cnt;

        public YearSelectionAdapter(List<YearSelectionPojo> ar, Context cnt) {
            this.ar = ar;
            this.cnt = cnt;
        }
        ...
        public View getView(final int pos, View view, ViewGroup viewGroup) {
            ...
            tv_time.setText(ar.get(pos).getYear_display_name());
