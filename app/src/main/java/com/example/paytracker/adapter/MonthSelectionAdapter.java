...
public class MonthSelectionAdapter extends BaseAdapter {
    List<MonthSelectionPojo> ar;
    Context cnt;

    public MonthSelectionAdapter(List<MonthSelectionPojo> ar, Context cnt) {
        this.ar = ar;
        this.cnt = cnt;
    }
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup) {
        ...
        tv_time.setText(ar.get(pos).getMonth_display_name());
