...
// Query lists the data of work using username and company name
$query_json ="SELECT * from tb_payment_history where uname='$uname' and company_name='$job_type' and work_date BETWEEN CAST('$start_date' AS DATE) AND CAST('$end_date' AS DATE)";
//json format array
